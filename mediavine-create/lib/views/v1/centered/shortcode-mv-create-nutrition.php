...
<div class="mv-create-nutrition">
	...
	<div class="mv-create-nutrition-box">
		...
		<h6 class="mv-create-nutrition-title mv-create-strong"><span><?php esc_html_e( 'Nutrition Information', 'mediavine-create' ); ?><?php echo ( $args['use_realistic_nutrition_display'] ) ? null : ':'; ?></span></h6>

		<?php if ( ! empty( $nutrition['number_of_servings'] ) ) { ?>
			<span class="mv-create-nutrition-item mv-create-nutrition-yield"><span class="mv-create-nutrition-label mv-create-uppercase"><?php esc_html_e( 'Yield', 'mediavine-create' ); ?><?php echo ( $args['use_realistic_nutrition_display'] ) ? null : ':'; ?></span> <?php echo esc_html( $nutrition['number_of_servings'] ); ?></span>
		<?php } ?>

		<?php if ( ! empty( $nutrition['serving_size'] ) ) { ?>
			<span class="mv-create-nutrition-item mv-create-nutrition-serving-size"><span class="mv-create-nutrition-label mv-create-uppercase"><?php esc_html_e( 'Serving Size', 'mediavine-create' ); ?><?php echo ( $args['use_realistic_nutrition_display'] ) ? null : ':'; ?></span> <?php echo esc_html( $nutrition['serving_size'] ); ?></span>
		<?php } ?>

		<br><span class="mv-create-nutrition-amount"><em><?php esc_html_e( 'Amount Per Serving', 'mediavine-create' ); ?><?php echo ( $args['use_realistic_nutrition_display'] ) ? null : ':'; ?></em></span>

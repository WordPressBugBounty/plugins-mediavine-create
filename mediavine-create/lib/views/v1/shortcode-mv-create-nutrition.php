...
<div class="mv-create-nutrition">
	<div class="mv-create-nutrition-box">
		...
		<?php if ( ! empty( $nutrition['number_of_servings'] ) ) { ?>
			<span class="mv-create-nutrition-item mv-create-nutrition-yield"><h3 class="mv-create-nutrition-label mv-create-uppercase mv-create-strong"><?php esc_html_e( 'Yield', 'mediavine-create' ); ?><?php echo ( $args['use_realistic_nutrition_display'] ) ? null : ':'; ?></h3> <?php echo esc_html( $nutrition['number_of_servings'] ); ?></span>
		<?php } ?>

		<?php if ( ! empty( $nutrition['serving_size'] ) ) { ?>
			<span class="mv-create-nutrition-item mv-create-nutrition-serving-size <?php echo $args['use_realistic_nutrition_display'] ? 'mv-create-traditional-nutrition-serving-size' : ''; ?>"><h3 class="mv-create-nutrition-label mv-create-uppercase mv-create-strong"><?php esc_html_e( 'Serving Size', 'mediavine-create' ); ?><?php echo ( $args['use_realistic_nutrition_display'] ) ? null : ':'; ?></h3> <?php echo esc_html( $nutrition['serving_size'] ); ?></span>
		<?php } ?>

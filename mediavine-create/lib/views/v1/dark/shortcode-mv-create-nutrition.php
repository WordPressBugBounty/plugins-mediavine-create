...
<div class="mv-create-nutrition">
	<div class="mv-create-nutrition-box">
		<h3 class="mv-create-nutrition-title mv-create-strong"><span><?php esc_html_e( 'Nutrition Information', 'mediavine-create' ); ?><?php echo ( $args['use_realistic_nutrition_display'] ) ? null : ':'; ?></span></h3>

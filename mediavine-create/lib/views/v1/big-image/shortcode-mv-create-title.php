...
<div class="mv-create-title-container<?php echo esc_attr( $title_class ); ?>">
	...
	<?php if ( ! empty( $args['creation']['yield'] ) ) { ?>
		<span class="mv-create-yield mv-create-uppercase"><span class="screen-reader-text"><?php esc_html_e( 'Yield', 'mediavine-create' ); ?>:</span> <?php echo esc_html( $args['creation']['yield'] ); ?></span>
	<?php } ?>

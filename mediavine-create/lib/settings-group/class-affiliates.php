	...
	public static function settings() {
		return [
			...
			[
				...
				'data'  => [
					'type'         => 'select',
					'label'        => __( 'Amazon Marketplace', 'mediavine' ),
					'instructions' => __( 'Select the Amazon marketplace your affiliate account is registered with.', 'mediavine' ),
					'default'      => 'US',
			...
			[
				...
				'data'  => [
					...
					'instructions' => __( 'The Amazon Associate Tag/Store ID for the selected marketplace.', 'mediavine' ),
					'default'      => '',
					'dependent_on' => Plugin::$settings_group . '_enable_amazon',
				],
			],

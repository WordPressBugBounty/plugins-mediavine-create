...
class Arr {
	 ...
	 */
	public static function filter( array $array, callable $func ): array {
		$results = [];
	...
	/**
	 * If the given value is not a numeric array, wrap it in an array.
	 *
	 * @param mixed $value
	 * @return array
	 */
	public static function wrap_numeric( $value ): array {
		if ( ! is_array( $value ) ) {

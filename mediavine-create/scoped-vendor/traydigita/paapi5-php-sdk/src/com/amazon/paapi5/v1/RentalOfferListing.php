...
class RentalOfferListing implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['availability' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferAvailability', 'basePrice' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\DurationPrice', 'condition' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferCondition', 'deliveryInfo' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferDeliveryInfo', 'id' => 'string', 'merchantInfo' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferMerchantInfo'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['availability' => null, 'basePrice' => null, 'condition' => null, 'deliveryInfo' => null, 'id' => null, 'merchantInfo' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['availability' => 'Availability', 'basePrice' => 'BasePrice', 'condition' => 'Condition', 'deliveryInfo' => 'DeliveryInfo', 'id' => 'Id', 'merchantInfo' => 'MerchantInfo'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['availability' => 'setAvailability', 'basePrice' => 'setBasePrice', 'condition' => 'setCondition', 'deliveryInfo' => 'setDeliveryInfo', 'id' => 'setId', 'merchantInfo' => 'setMerchantInfo'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['availability' => 'getAvailability', 'basePrice' => 'getBasePrice', 'condition' => 'getCondition', 'deliveryInfo' => 'getDeliveryInfo', 'id' => 'getId', 'merchantInfo' => 'getMerchantInfo'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

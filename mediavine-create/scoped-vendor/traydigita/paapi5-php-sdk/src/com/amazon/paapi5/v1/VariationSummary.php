...
class VariationSummary implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['pageCount' => 'int', 'price' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\Price', 'variationCount' => 'int', 'variationDimensions' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\VariationDimension[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['pageCount' => 'int32', 'price' => null, 'variationCount' => 'int32', 'variationDimensions' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['pageCount' => 'PageCount', 'price' => 'Price', 'variationCount' => 'VariationCount', 'variationDimensions' => 'VariationDimensions'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['pageCount' => 'setPageCount', 'price' => 'setPrice', 'variationCount' => 'setVariationCount', 'variationDimensions' => 'setVariationDimensions'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['pageCount' => 'getPageCount', 'price' => 'getPrice', 'variationCount' => 'getVariationCount', 'variationDimensions' => 'getVariationDimensions'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

...
class OfferMerchantInfo implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['defaultShippingCountry' => 'string', 'feedbackCount' => 'int', 'feedbackRating' => 'float', 'id' => 'string', 'name' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['defaultShippingCountry' => null, 'feedbackCount' => 'int32', 'feedbackRating' => null, 'id' => null, 'name' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['defaultShippingCountry' => 'DefaultShippingCountry', 'feedbackCount' => 'FeedbackCount', 'feedbackRating' => 'FeedbackRating', 'id' => 'Id', 'name' => 'Name'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['defaultShippingCountry' => 'setDefaultShippingCountry', 'feedbackCount' => 'setFeedbackCount', 'feedbackRating' => 'setFeedbackRating', 'id' => 'setId', 'name' => 'setName'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['defaultShippingCountry' => 'getDefaultShippingCountry', 'feedbackCount' => 'getFeedbackCount', 'feedbackRating' => 'getFeedbackRating', 'id' => 'getId', 'name' => 'getName'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

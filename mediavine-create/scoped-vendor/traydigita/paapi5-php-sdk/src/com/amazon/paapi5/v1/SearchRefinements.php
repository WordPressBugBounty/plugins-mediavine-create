...
class SearchRefinements implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['browseNode' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\Refinement', 'otherRefinements' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\Refinement[]', 'searchIndex' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\Refinement'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['browseNode' => null, 'otherRefinements' => null, 'searchIndex' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['browseNode' => 'BrowseNode', 'otherRefinements' => 'OtherRefinements', 'searchIndex' => 'SearchIndex'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['browseNode' => 'setBrowseNode', 'otherRefinements' => 'setOtherRefinements', 'searchIndex' => 'setSearchIndex'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['browseNode' => 'getBrowseNode', 'otherRefinements' => 'getOtherRefinements', 'searchIndex' => 'getSearchIndex'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

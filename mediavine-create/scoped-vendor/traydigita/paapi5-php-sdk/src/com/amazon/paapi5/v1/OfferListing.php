...
class OfferListing implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['availability' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferAvailability', 'condition' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferCondition', 'deliveryInfo' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferDeliveryInfo', 'id' => 'string', 'isBuyBoxWinner' => 'bool', 'loyaltyPoints' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferLoyaltyPoints', 'merchantInfo' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferMerchantInfo', 'price' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferPrice', 'programEligibility' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferProgramEligibility', 'promotions' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferPromotion[]', 'savingBasis' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferPrice', 'violatesMAP' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['availability' => null, 'condition' => null, 'deliveryInfo' => null, 'id' => null, 'isBuyBoxWinner' => null, 'loyaltyPoints' => null, 'merchantInfo' => null, 'price' => null, 'programEligibility' => null, 'promotions' => null, 'savingBasis' => null, 'violatesMAP' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['availability' => 'Availability', 'condition' => 'Condition', 'deliveryInfo' => 'DeliveryInfo', 'id' => 'Id', 'isBuyBoxWinner' => 'IsBuyBoxWinner', 'loyaltyPoints' => 'LoyaltyPoints', 'merchantInfo' => 'MerchantInfo', 'price' => 'Price', 'programEligibility' => 'ProgramEligibility', 'promotions' => 'Promotions', 'savingBasis' => 'SavingBasis', 'violatesMAP' => 'ViolatesMAP'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['availability' => 'setAvailability', 'condition' => 'setCondition', 'deliveryInfo' => 'setDeliveryInfo', 'id' => 'setId', 'isBuyBoxWinner' => 'setIsBuyBoxWinner', 'loyaltyPoints' => 'setLoyaltyPoints', 'merchantInfo' => 'setMerchantInfo', 'price' => 'setPrice', 'programEligibility' => 'setProgramEligibility', 'promotions' => 'setPromotions', 'savingBasis' => 'setSavingBasis', 'violatesMAP' => 'setViolatesMAP'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['availability' => 'getAvailability', 'condition' => 'getCondition', 'deliveryInfo' => 'getDeliveryInfo', 'id' => 'getId', 'isBuyBoxWinner' => 'getIsBuyBoxWinner', 'loyaltyPoints' => 'getLoyaltyPoints', 'merchantInfo' => 'getMerchantInfo', 'price' => 'getPrice', 'programEligibility' => 'getProgramEligibility', 'promotions' => 'getPromotions', 'savingBasis' => 'getSavingBasis', 'violatesMAP' => 'getViolatesMAP'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

...
class Price implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['highestPrice' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferPrice', 'lowestPrice' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferPrice'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['highestPrice' => null, 'lowestPrice' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['highestPrice' => 'HighestPrice', 'lowestPrice' => 'LowestPrice'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['highestPrice' => 'setHighestPrice', 'lowestPrice' => 'setLowestPrice'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['highestPrice' => 'getHighestPrice', 'lowestPrice' => 'getLowestPrice'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

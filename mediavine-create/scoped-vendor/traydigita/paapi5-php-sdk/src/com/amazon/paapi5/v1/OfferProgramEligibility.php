...
class OfferProgramEligibility implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['isPrimeExclusive' => 'bool', 'isPrimePantry' => 'bool'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['isPrimeExclusive' => null, 'isPrimePantry' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['isPrimeExclusive' => 'IsPrimeExclusive', 'isPrimePantry' => 'IsPrimePantry'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['isPrimeExclusive' => 'setIsPrimeExclusive', 'isPrimePantry' => 'setIsPrimePantry'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['isPrimeExclusive' => 'getIsPrimeExclusive', 'isPrimePantry' => 'getIsPrimePantry'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

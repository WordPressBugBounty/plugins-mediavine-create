...
class GetBrowseNodesRequest implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['browseNodeIds' => 'string[]', 'languagesOfPreference' => 'string[]', 'marketplace' => 'string', 'partnerTag' => 'string', 'partnerType' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\PartnerType', 'resources' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\GetBrowseNodesResource[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['browseNodeIds' => null, 'languagesOfPreference' => null, 'marketplace' => null, 'partnerTag' => null, 'partnerType' => null, 'resources' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['browseNodeIds' => 'BrowseNodeIds', 'languagesOfPreference' => 'LanguagesOfPreference', 'marketplace' => 'Marketplace', 'partnerTag' => 'PartnerTag', 'partnerType' => 'PartnerType', 'resources' => 'Resources'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['browseNodeIds' => 'setBrowseNodeIds', 'languagesOfPreference' => 'setLanguagesOfPreference', 'marketplace' => 'setMarketplace', 'partnerTag' => 'setPartnerTag', 'partnerType' => 'setPartnerType', 'resources' => 'setResources'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['browseNodeIds' => 'getBrowseNodeIds', 'languagesOfPreference' => 'getLanguagesOfPreference', 'marketplace' => 'getMarketplace', 'partnerTag' => 'getPartnerTag', 'partnerType' => 'getPartnerType', 'resources' => 'getResources'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

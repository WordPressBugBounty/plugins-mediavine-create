...
class Item implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['aSIN' => 'string', 'browseNodeInfo' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\BrowseNodeInfo', 'customerReviews' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\CustomerReviews', 'detailPageURL' => 'string', 'images' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\Images', 'itemInfo' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\ItemInfo', 'offers' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\Offers', 'parentASIN' => 'string', 'rentalOffers' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\RentalOffers', 'score' => 'float', 'variationAttributes' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\VariationAttribute[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['aSIN' => null, 'browseNodeInfo' => null, 'customerReviews' => null, 'detailPageURL' => null, 'images' => null, 'itemInfo' => null, 'offers' => null, 'parentASIN' => null, 'rentalOffers' => null, 'score' => null, 'variationAttributes' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['aSIN' => 'ASIN', 'browseNodeInfo' => 'BrowseNodeInfo', 'customerReviews' => 'CustomerReviews', 'detailPageURL' => 'DetailPageURL', 'images' => 'Images', 'itemInfo' => 'ItemInfo', 'offers' => 'Offers', 'parentASIN' => 'ParentASIN', 'rentalOffers' => 'RentalOffers', 'score' => 'Score', 'variationAttributes' => 'VariationAttributes'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['aSIN' => 'setASIN', 'browseNodeInfo' => 'setBrowseNodeInfo', 'customerReviews' => 'setCustomerReviews', 'detailPageURL' => 'setDetailPageURL', 'images' => 'setImages', 'itemInfo' => 'setItemInfo', 'offers' => 'setOffers', 'parentASIN' => 'setParentASIN', 'rentalOffers' => 'setRentalOffers', 'score' => 'setScore', 'variationAttributes' => 'setVariationAttributes'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['aSIN' => 'getASIN', 'browseNodeInfo' => 'getBrowseNodeInfo', 'customerReviews' => 'getCustomerReviews', 'detailPageURL' => 'getDetailPageURL', 'images' => 'getImages', 'itemInfo' => 'getItemInfo', 'offers' => 'getOffers', 'parentASIN' => 'getParentASIN', 'rentalOffers' => 'getRentalOffers', 'score' => 'getScore', 'variationAttributes' => 'getVariationAttributes'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

...
class OfferCondition implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['displayValue' => 'string', 'label' => 'string', 'locale' => 'string', 'value' => 'string', 'subCondition' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferSubCondition', 'conditionNote' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferConditionNote'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['displayValue' => null, 'label' => null, 'locale' => null, 'value' => null, 'subCondition' => null, 'conditionNote' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['displayValue' => 'DisplayValue', 'label' => 'Label', 'locale' => 'Locale', 'value' => 'Value', 'subCondition' => 'SubCondition', 'conditionNote' => 'ConditionNote'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['displayValue' => 'setDisplayValue', 'label' => 'setLabel', 'locale' => 'setLocale', 'value' => 'setValue', 'subCondition' => 'setSubCondition', 'conditionNote' => 'setConditionNote'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['displayValue' => 'getDisplayValue', 'label' => 'getLabel', 'locale' => 'getLocale', 'value' => 'getValue', 'subCondition' => 'getSubCondition', 'conditionNote' => 'getConditionNote'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

...
class SearchResult implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['totalResultCount' => 'int', 'searchURL' => 'string', 'items' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\Item[]', 'searchRefinements' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\SearchRefinements'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['totalResultCount' => 'int64', 'searchURL' => null, 'items' => null, 'searchRefinements' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['totalResultCount' => 'TotalResultCount', 'searchURL' => 'SearchURL', 'items' => 'Items', 'searchRefinements' => 'SearchRefinements'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['totalResultCount' => 'setTotalResultCount', 'searchURL' => 'setSearchURL', 'items' => 'setItems', 'searchRefinements' => 'setSearchRefinements'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['totalResultCount' => 'getTotalResultCount', 'searchURL' => 'getSearchURL', 'items' => 'getItems', 'searchRefinements' => 'getSearchRefinements'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

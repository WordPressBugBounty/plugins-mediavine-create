...
class OfferSummary implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['condition' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferCondition', 'highestPrice' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferPrice', 'lowestPrice' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferPrice', 'offerCount' => 'int'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['condition' => null, 'highestPrice' => null, 'lowestPrice' => null, 'offerCount' => 'int32'];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['condition' => 'Condition', 'highestPrice' => 'HighestPrice', 'lowestPrice' => 'LowestPrice', 'offerCount' => 'OfferCount'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['condition' => 'setCondition', 'highestPrice' => 'setHighestPrice', 'lowestPrice' => 'setLowestPrice', 'offerCount' => 'setOfferCount'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['condition' => 'getCondition', 'highestPrice' => 'getHighestPrice', 'lowestPrice' => 'getLowestPrice', 'offerCount' => 'getOfferCount'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

...
class OfferDeliveryInfo implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['isAmazonFulfilled' => 'bool', 'isFreeShippingEligible' => 'bool', 'isPrimeEligible' => 'bool', 'shippingCharges' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferShippingCharge[]'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['isAmazonFulfilled' => null, 'isFreeShippingEligible' => null, 'isPrimeEligible' => null, 'shippingCharges' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['isAmazonFulfilled' => 'IsAmazonFulfilled', 'isFreeShippingEligible' => 'IsFreeShippingEligible', 'isPrimeEligible' => 'IsPrimeEligible', 'shippingCharges' => 'ShippingCharges'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['isAmazonFulfilled' => 'setIsAmazonFulfilled', 'isFreeShippingEligible' => 'setIsFreeShippingEligible', 'isPrimeEligible' => 'setIsPrimeEligible', 'shippingCharges' => 'setShippingCharges'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['isAmazonFulfilled' => 'getIsAmazonFulfilled', 'isFreeShippingEligible' => 'getIsFreeShippingEligible', 'isPrimeEligible' => 'getIsPrimeEligible', 'shippingCharges' => 'getShippingCharges'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
